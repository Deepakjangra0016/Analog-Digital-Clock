...
# Hour Lablel ------------------
lbl_hr = Label(root,text="12", font=("Roboto", 50, "bold"), bg="#0875B7", fg="white")
...
# Minute Lablel ----------------
lbl_min = Label(root,text="12", font=("Roboto", 50, "bold"), bg="#008EA4", fg="white")
...
# Second Lablel ----------------
lbl_sec = Label(root,text="12", font=("Roboto", 50, "bold"), bg="#DF002A", fg="white")
lbl_sec.place(x=690, y=200, width=150, height=150)

lbl_sec2 = Label(root,text="SECOND", font=("Roboto", 20, "bold"), bg="#DF002A", fg="white")
lbl_sec2.place(x=690, y=360, width=150, height=50)

# noon Lablel ----------------
lbl_noon = Label(root,text="AM", font=("Roboto", 50, "bold"), bg="#DF002A", fg="white")
lbl_noon.place(x=860, y=200, width=150, height=150)

lbl_noon2 = Label(root,text="NOON", font=("Roboto", 20, "bold"), bg="#DF002A", fg="white")
